...
param environmentName string = 'cloudguard'
...
var postgresAdminLogin = 'cloudguard'
...
module containerApp 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    databaseUrl: 'postgresql://${postgresAdminLogin}:${postgresAdminPassword}@${postgres.outputs.fqdn}:5432/cloudguard?sslmode=require'
    apiKey: apiKey
...
@description('Deployment output: paste into CloudGuard\'s frontend along with the API key to pair.')
